...
public class EditComponentViewModel {
    ...
    /**
     * Initializes a new instance of the EditComponentViewModel class.
     * Sets up property bindings and initializes the connection to the component inventory for data retrieval and updates.
     */
    ...
    /**
     * Sets the currently selected component for editing, updating the ViewModel's properties to reflect the component's current values.
     *
    ...
    /**
     * Applies the changes made to the component's details in the ViewModel back to the inventory.
     * Updates the component's name, cost, and quantity based on the values entered by the user.
     *
     * @return true if the component was successfully updated in the inventory, false otherwise.
     */
    ...
    /**
     * Gets the name property of the component being edited. This property is bound to the corresponding input field in the UI.
     *
	...
	/**
	 * Gets the cost property of the component being edited. This property is bound to the corresponding input field in the UI.
	 *
	...
	/**
	 * Gets the quantity property of the component being edited. This property is bound to the corresponding input field in the UI.
	 *
	 * @return A StringProperty representing the component's quantity in the inventory.
	 */
