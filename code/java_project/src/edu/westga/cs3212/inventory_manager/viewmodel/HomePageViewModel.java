...
public class HomePageViewModel {
     ...
     * StringProperties for binding to the UI text areas that display the summaries.
     */
     ...
     *
     * @return The StringProperty bound to the component summary text area in the
     *         UI.
     */
     ...
     * summary text area. The summary includes the top 5 most used components based
     * on their usage in product recipes.
     */
    ...
    /**
     * Generates a summary of the most requested products and updates the product
     * summary text area. The summary includes the top 5 most requested products
     ...
     * production costs, profits, completed orders, and orders in progress. Updates
     * the order summary text area with this information.
     */
