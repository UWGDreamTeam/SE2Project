...
public class AddProductViewModel {
     ...
     * product inventories.
     *
     * @param componentInventory The inventory of components available for creating
     *                           a product.
    ...
    /**
     * Adds a new product to the product inventory using the provided recipe and the
     * data bound to this ViewModel.
     * 
     * @param recipe A map of components and their quantities required for the new
     *               product.
     * @throws NumberFormatException If the production cost, selling price, or
     *                               quantity cannot be parsed to their respective
     *                               numeric types.
     */
