...
public class AddProductViewModel {
	...
	private LocalProductInventory productInventory;
	 ...
	 /**
     * Constructs an AddProductViewModel with references to the component and product inventories.
     *
     * @param componentInventory The inventory of components available for creating a product.
     * @param productInventory The inventory where the new product will be added.
     */
	...
	/**
     * Provides an observable list of components for the UI, derived from the component inventory.
     * 
	...
	/**
     * Adds a new product to the product inventory using the provided recipe and the data bound to this ViewModel.
     * 
     * @param recipe A map of components and their quantities required for the new product.
     * @throws NumberFormatException If the production cost, selling price, or quantity cannot be parsed to their respective numeric types.
     */
