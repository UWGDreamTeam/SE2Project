...
public class LocalEmployeeCredentialsManager extends SystemCredentialsManager {
	 ...
	 *               && !employeeType.isBlank() && firstName != null &&
	...
	public void addEmployee(String firstName, String lastName, String password, String employeeType) {
		...
		LocalEmployeeCredentials newEmployee = new LocalEmployeeCredentials(employeeID, firstName, lastName, password,
				type);
		...
		EmployeeCredentialsStorage.save(LocalEmployeeCredentialsManager.employeeCredentialsMap,
	 ...
	 * 
	 * @precondition employeeID != null && !employeeID.isBlank() && password != null
	 *               && !password.isBlank()
