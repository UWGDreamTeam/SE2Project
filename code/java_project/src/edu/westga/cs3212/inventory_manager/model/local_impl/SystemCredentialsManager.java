...
public abstract class SystemCredentialsManager {
     ...
     * @param employeeID ID of the employee
     * 
     * @return true if employee removed successfully false if employee not removed
     *         successfully
     */
     ...
     * 
     * @precondition employeeID != null && !employeeID.isEmpty() &&
     *               !getEmployeeIDs().contains(employeeID) && password != null &&
     *               !password.isEmpty() && firstName != null &&
     ...
     * 
     * @precondition employeeID != null && !employeeID.isEmpty() && password != null
     ...
     * 
     * @return true if employee's password updated successfully false if employee's
