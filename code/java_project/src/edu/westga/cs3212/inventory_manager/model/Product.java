...
public class Product extends Item {
	 ...
	 * @param recipe         a map of components and their quantities required to
	 *                       produce the product
	 * 
	 ...
	 * 
	 * @throws IllegalArgumentException if the recipe is null or empty, if sale
	 *                                  price or production cost is negative
	 */
	...
	/**
	 * Adds a component and its quantity to the product's recipe if the component is
	 ...
	 *                getRecipe().get(component) == quantity if component was not
	 *                already in the recipe
	 * 
	 * @return true if the component was added to the recipe, false if the component
	 *         was already in the recipe
	 * @throws IllegalArgumentException if the component is null or the quantity is
	 *                                  less than the minimum required quantity
	 */
	 ...
	 * 
	 * @throws IllegalArgumentException if the new components map is null, empty, or
	 *                                  contains null keys
	 */
