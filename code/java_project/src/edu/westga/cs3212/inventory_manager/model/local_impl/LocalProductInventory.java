...
public class LocalProductInventory implements ItemInventoryManager {
    ...
    /**
     * Initializes a new instance of the LocalProductInventory class. Loads existing
     * products from storage or initializes the inventory with demo data if no
	...
	if (LocalProductInventory.products == null) {
		...
		LocalProductInventory.products = DemoDataUtility
			.createDemoProducts(componentInventory.getItemsWithQuantities());
		this.save();
	    }
	}
    }
