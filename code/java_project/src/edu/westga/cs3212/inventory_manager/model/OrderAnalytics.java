 ...
 * This class utilizes the LocalOrderManager to aggregate and compute various metrics
 * such as total sales, production costs, profits, and counts of orders in different completion statuses.
 *
 * @author Group 1
 * @version Spring 2024
 */
public class OrderAnalytics {
	...
	/**
     * Calculates the total profit from completed orders.
     * The profit is determined by subtracting the total production costs from the total sales.
     * 
