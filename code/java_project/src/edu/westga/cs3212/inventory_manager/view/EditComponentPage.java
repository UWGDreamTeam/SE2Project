...
public class EditComponentPage {
    ...
    /**
     * Initializes the UI with the data from the specified item for editing. Binds
     * the item's properties (name, cost, and quantity) to the corresponding input
     * fields in the UI, allowing for the editing of the item's attributes.
     *
